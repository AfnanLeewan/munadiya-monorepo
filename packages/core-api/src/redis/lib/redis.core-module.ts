...
export class RedisCoreModule {
  ...
  public static forRootAsync(
    ...
    const redisConnectionProvider: Provider = {
      provide: getRedisConnectionToken(connection),
      useFactory(redisModuleOptions: RedisModuleOptions) {
        return createRedisConnection(redisModuleOptions)
      },
  ...
  public static createAsyncOptionsProvider(
    ...
    return {
      ...
      async useFactory(
        ...
        const createdResult = await optionsFactory.createRedisModuleOptions()
